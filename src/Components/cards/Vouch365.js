...
class Vouch365 extends Component {
  constructor(props) {
    super(props);
    this.state = {
      loader: false,
  ...
  oladocSubmit(){
    console.log('oladocSubmit');
    var data = new FormData();
    data.append('secret_key', "ce172e3f912cc104ec52156ef3344463");
    data.append('country_code', "+92");
    data.append('verified_mobile_number', "03004324038");
    data.append('name', "Usman");
    data.append('city', "karachi");
    this.setState({
      loader:true,
    },()=>{
      axios({
        url: 'https://staging.oladoc.com/widget',
        method: 'post',
        headers: {
      ...
      <Animatable.View
        ...
        resizeMode="stretch"
         style={{ 
          ...
          source={require('../../../assets/icons/android/drawable-xxxhdpi/vouch365.png')}
        />
        <Modal
        animationIn="fadeIn"
